...
description: 诗遇——把唐诗宋词和真实生活连起来的 skill（日签/每日诗词/今日一句/Chinese poetry daily quote）。五大模式：A 有感而发（描述一段经历或心情→主题索引匹配诗词→生成朋友圈文案、小红书文案）；B 学习沉淀（分级深度：快拆/标准拆解（含炼字）/深读（含对比读法+历代笺注）→定位诗人人生阶段→人话背景+古今映射→学习笔记，自动记录学习进度，连学同主题自动提议对照读）；C 今日日签（按节气/天气/日期/星期推荐一首诗+金句口令+推荐理由+寓意，天气经 wttr.in 免key API 关联，诗人轮换：李白/杜甫/苏轼）；D 复习验收（艾宾浩斯遗忘曲线间隔复习+背诵验收，含场景联想题，每晚定时提醒）；E 学习周报（每周数据统计+可发朋友圈的读诗周记）。诗库五件套：底库（libai_raw.json 李白全集 1149 首 + poets_selected.json 杜甫苏轼精选 114 首，chinese-poetry MIT）+ 精读库（poems.md 45 首人话精读）+ 诗人档案（poets_profile.md 三诗人人生阶段线）+ 主题索引（themes.md 14 主题）+ 天气映射（weather_map.md），持续扩充。触发词：日签、今日一句、每日诗词、每日唐诗、唐诗、宋词、古诗、古诗词、诗词、李白、杜甫、苏轼、配诗、找一句诗、诗词配图、朋友圈文案、小红书文案、背诗、背诵、验收、背一下、复习、抽查、节气、周报、读诗周记、拆解、深读、精讲、快速过一下。零依赖纯本地（进度与个人配置存 ~/.workbuddy/poetry-resonance/），可选联网（搜韵笺注核对 + wttr.in 天气）。
---
